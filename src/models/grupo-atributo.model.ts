...
@model({
  settings: {idInjection: false, mysql: {schema: 'pim_dynamizatic', table: 'grupo_atributo'}}
})
export class GrupoAtributo extends Entity {
  @property({
    type: 'number',
    precision: 11,
    scale: 0,
  ...
  constructor(data?: Partial<GrupoAtributo>) {
    super(data);
  }
}

export interface GrupoAtributoRelations {
  // describe navigational properties here
}

export type GrupoAtributoWithRelations = GrupoAtributo & GrupoAtributoRelations;