...
@model({
  settings: {idInjection: false, mysql: {schema: 'pim_dynamizatic', table: 'categoria'}}
})
export class Categoria extends Entity {
  ...
  @property({
    ...
    scale: 0,
    generated: false,
    mysql: {columnName: 'categoriaPadreId', dataType: 'int', dataLength: null, dataPrecision: 11, dataScale: 0, nullable: 'Y', generated: false},
  })
  ...
  @property({
    ...
    length: 250,
    generated: false,
    mysql: {columnName: 'imagen', dataType: 'varchar', dataLength: 250, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  imagen?: string;
