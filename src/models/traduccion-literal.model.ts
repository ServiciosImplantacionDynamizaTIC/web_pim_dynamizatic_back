...
@model({
  settings: {idInjection: false, mysql: {schema: 'pim_dynamizatic', table: 'traduccion_literal'}}
})
export class TraduccionLiteral extends Entity {
  @property({
    type: 'number',
    precision: 11,
    scale: 0,
  ...
  @property({
    ...
    length: 200,
    generated: false,
    mysql: {columnName: 'clave', dataType: 'varchar', dataLength: 200, dataPrecision: null, dataScale: null, nullable: 'N', generated: false},
  })
  clave: string;
  ...
  constructor(data?: Partial<TraduccionLiteral>) {
    super(data);
  }
}

export interface TraduccionLiteralRelations {
  // describe navigational properties here
}

export type TraduccionLiteralWithRelations = TraduccionLiteral & TraduccionLiteralRelations;