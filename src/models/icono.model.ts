...
@model({
  settings: {idInjection: false, mysql: {schema: 'pim_dynamizatic', table: 'icono'}}
})
export class Icono extends Entity {
  @property({
    type: 'number',
    precision: 11,
    scale: 0,
  ...
  constructor(data?: Partial<Icono>) {
    super(data);
  }
}

export interface IconoRelations {
  // describe navigational properties here
}

export type IconoWithRelations = Icono & IconoRelations;