...
@model({
  settings: {idInjection: false, mysql: {schema: 'pim_dynamizatic', table: 'mensaje_tipo'}}
})
export class MensajeTipo extends Entity {
  @property({
    type: 'number',
  ...
  constructor(data?: Partial<MensajeTipo>) {
    super(data);
  }
}

export interface MensajeTipoRelations {
  // describe navigational properties here
}

export type MensajeTipoWithRelations = MensajeTipo & MensajeTipoRelations;
