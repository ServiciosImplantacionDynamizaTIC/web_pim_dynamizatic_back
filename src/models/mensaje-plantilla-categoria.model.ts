...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'pim_dynamizatic', table: 'mensaje_plantilla_categoria'}
  }
})
export class MensajePlantillaCategoria extends Entity {
  @property({
    type: 'number',
  ...
  constructor(data?: Partial<MensajePlantillaCategoria>) {
    super(data);
  }
}

export interface MensajePlantillaCategoriaRelations {
  // describe navigational properties here
}

export type MensajePlantillaCategoriaWithRelations = MensajePlantillaCategoria & MensajePlantillaCategoriaRelations;
