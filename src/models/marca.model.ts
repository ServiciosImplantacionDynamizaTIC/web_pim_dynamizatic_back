...
@model({
  settings: {idInjection: false, mysql: {schema: 'pim_dynamizatic', table: 'marca'}}
})
export class Marca extends Entity {
  ...
  @property({
    ...
    length: 250,
    generated: false,
    mysql: {columnName: 'logo', dataType: 'varchar', dataLength: 250, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  logo?: string;
  ...
  @property({
    ...
    length: 200,
    generated: false,
    mysql: {columnName: 'sitioWeb', dataType: 'varchar', dataLength: 200, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  sitioWeb?: string;
  ...
  @property({
    ...
    length: 100,
    generated: false,
    mysql: {columnName: 'paisOrigen', dataType: 'varchar', dataLength: 100, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  paisOrigen?: string;
