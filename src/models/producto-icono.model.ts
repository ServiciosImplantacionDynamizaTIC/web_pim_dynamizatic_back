...
@model({
  settings: {idInjection: false, mysql: {schema: 'pim_dynamizatic', table: 'producto_icono'}}
})
export class ProductoIcono extends Entity {
  @property({
    type: 'number',
    precision: 11,
    scale: 0,
  ...
  @property({
    ...
    scale: 0,
    generated: false,
    mysql: {columnName: 'iconoId', dataType: 'int', dataLength: null, dataPrecision: 11, dataScale: 0, nullable: 'N', generated: false},
  })
  iconoId: number;
  ...
  @property({
    ...
    length: 100,
    generated: false,
    mysql: {columnName: 'textoAsociado', dataType: 'varchar', dataLength: 100, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  ...
  constructor(data?: Partial<ProductoIcono>) {
    super(data);
  }
}

export interface ProductoIconoRelations {
  // describe navigational properties here
}

export type ProductoIconoWithRelations = ProductoIcono & ProductoIconoRelations;