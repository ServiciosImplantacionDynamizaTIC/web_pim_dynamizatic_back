...
@model({
  settings: {idInjection: false, mysql: {schema: 'pim_dynamizatic', table: 'mensaje_plantilla'}}
})
export class MensajePlantilla extends Entity {
  @property({
    type: 'number',
  ...
  @property({
    ...
    scale: 0,
    generated: false,
    mysql: {columnName: 'mensajePlantillaCategoriaId', dataType: 'smallint', dataLength: null, dataPrecision: 6, dataScale: 0, nullable: 'N', generated: false},
  })
  ...
  @property({
    ...
    length: 5000,
    generated: false,
    mysql: {columnName: 'textoCuerpo', dataType: 'varchar', dataLength: 5000, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  textoCuerpo?: string;
  ...
  constructor(data?: Partial<MensajePlantilla>) {
    super(data);
  }
}

export interface MensajePlantillaRelations {
  // describe navigational properties here
}

export type MensajePlantillaWithRelations = MensajePlantilla & MensajePlantillaRelations;
